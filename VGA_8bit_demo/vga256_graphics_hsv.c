...
static PT_THREAD (protothread_graphics(struct pt *pt)) {
    ...
    for (int i=0; i<hsv_hres; i++) {
      for (int j=0; j<=hsv_sres; j++){
        ...
        fillRect(120+(int)(hsv_sres*(float)j/hsv_sres*cos_table[i]), 60+(int)(hsv_sres*(float)j/hsv_sres*sin_table[i]), 2, 2, 
            hsv2rgb((float)i*360/hsv_hres, (float)j/hsv_sres, 0.9)); 
        fillRect(200+(int)(hsv_sres*(float)j/hsv_sres*cos_table[i]), 60+(int)(hsv_sres*(float)j/hsv_sres*sin_table[i]), 2, 2, 
            hsv2rgb((float)i*360/hsv_hres, (float)j/hsv_sres, 0.8)); 
        fillRect(280+(int)(hsv_sres*(float)j/hsv_sres*cos_table[i]), 60+(int)(hsv_sres*(float)j/hsv_sres*sin_table[i]), 2, 2, 
            hsv2rgb((float)i*360/hsv_hres, (float)j/hsv_sres, 0.7)); 
        fillRect(40+(int)(hsv_sres*(float)j/hsv_sres*cos_table[i]), 140+(int)(hsv_sres*(float)j/hsv_sres*sin_table[i]), 2, 2, 
            hsv2rgb((float)i*360/hsv_hres, (float)j/hsv_sres, 0.6)); 
        fillRect(120+(int)(hsv_sres*(float)j/hsv_sres*cos_table[i]), 140+(int)(hsv_sres*(float)j/hsv_sres*sin_table[i]), 2, 2, 
            hsv2rgb((float)i*360/hsv_hres, (float)j/hsv_sres, 0.5));
        fillRect(200+(int)(hsv_sres*(float)j/hsv_sres*cos_table[i]), 140+(int)(hsv_sres*(float)j/hsv_sres*sin_table[i]), 2, 2, 
            hsv2rgb((float)i*360/hsv_hres, (float)j/hsv_sres, 0.4)); 
        fillRect(280+(int)(hsv_sres*(float)j/hsv_sres*cos_table[i]), 140+(int)(hsv_sres*(float)j/hsv_sres*sin_table[i]), 2, 2, 
            hsv2rgb((float)i*360/hsv_hres, (float)j/hsv_sres, 0.3)); 
    ...
    PT_BEGIN(pt);
      ...
      while(1) {
        ...
        */
        ...
        printf("%02x\n\r", rgb_box) ;
        fillRect(145, 170, 30, 30, rgb_box); 
        setCursor(125, 180) ; 
