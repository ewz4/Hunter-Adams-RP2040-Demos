...
static PT_THREAD(protothread_vga(struct pt *pt))
{
    ...
    while (true)
    {
        ...
        if (throttle >= threshold)
        {
            ...
            // Plot Duty Cycle
            drawPixel(xcoord, 230 - (int)((float)(proportional)*150 / 5000), WHITE);
            drawPixel(xcoord, 230 - (int)((float)(derivative)*150 / 5000), RED);
            drawPixel(xcoord, 230 - (int)((float)(integral)*150 / 5000), CYAN);
